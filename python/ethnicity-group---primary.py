...
codes = [{"code":"226Z","system":"readv2"},{"code":"9S","system":"readv2"},{"code":"9SE","system":"readv2"},{"code":"9SJ","system":"readv2"},{"code":"226","system":"readv2"},{"code":"9iFK","system":"readv2"},{"code":"9T1A","system":"readv2"},{"code":"9SZ","system":"readv2"}];
REQUIRED_CODES = 1;
